...
joblib.dump(unquant_params, "src/models/unquant_params.joblib")
...
joblib.dump(quant_params, "src/models/quant_params.joblib")
...
torch.save(model_torch.state_dict(), "src/models/quantized_model.pth")
...
unquant_size = os.path.getsize("src/models/unquant_params.joblib") / 1024
quant_size = os.path.getsize("src/models/quant_params.joblib") / 1024
